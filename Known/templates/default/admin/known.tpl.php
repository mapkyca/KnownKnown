    ...
    <div class="col-md-10 col-md-offset-1">
		...
		<div class="controls">
			...
			If you plan to connect via <a href="https://github.com/mapkyca/KnownOAuth2" target="_blank">OAuth2</a>, enter the application details below.
                ...
                <div class="controls">
                    <input type="text" id="name" placeholder="App Key" class="col-md-4" name="appId" value="<?= htmlspecialchars(\Idno\Core\site()->config()->known['appId']) ?>" >
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="name">Client Secret</label>
                <div class="controls">
                    <input type="text" id="name" placeholder="Secret Key" class="col-md-4" name="secret" value="<?= htmlspecialchars(\Idno\Core\site()->config()->known['secret']) ?>" >
                </div>
            </div>
            <div class="control-group">
                <div class="controls">
