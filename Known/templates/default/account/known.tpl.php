...
<div class="row">
    <div class="col-md-10 col-md-offset-1">
		...
		?>
    		...
    		<div class="controls">
    		    <input type="text" id="username" placeholder="Username on remote known installation" class="col-md-4" name="username" value="<?= htmlspecialchars(\Idno\Core\site()->session()->currentUser()->known['username']) ?>" >
    		</div>

    		<label class="control-label" for="name">Remote user's API Key</label>
    		<div class="controls">
    		    <input type="text" id="known_api_key" placeholder="Secret Key" class="col-md-4" name="known_api_key" value="<?= htmlspecialchars(\Idno\Core\site()->session()->currentUser()->known['known_api_key']) ?>" >
    		</div>
    	    </div>
	    <div class="control-group">
                <div class="controls">
